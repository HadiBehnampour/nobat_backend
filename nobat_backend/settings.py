"""
Django settings for nobat_backend project.
...
SECRET_KEY = 'django-insecure-zd@slpi99al!d8@xrh9*jea&%f2y4-0(#s)rr0-tedn#vy1f5)'
...
ROOT_URLCONF = 'nobat_backend.urls'
...
WSGI_APPLICATION = 'nobat_backend.wsgi.application'
